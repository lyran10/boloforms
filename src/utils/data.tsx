...
export const array = [
{
  ...
  header : "Get started in less than 5 minutes.",
  para : "Just use an existing Google Form, add approvers, and we'll notify them via email when submissions are made."
},
{
  icon : "https://www.boloforms.com/_next/static/media/pr_dyncaseroute.02285ff2.svg",
  header : "Multi-level workflows",
  para : "To ensure that your executives do not approve a document until it has been reviewed and accepted by other employees, you can set up multi-level approval processes.."
},
{
...
},
{
  ...
  header : "Role Based Workflows",
  para : "Assign the following roles to your recipients: Approver, Receive a Copy, and Send Final Email Only."
},
{
  icon : "https://www.boloforms.com/_next/static/media/pr_visualprcdesign.0ff90171.svg",
  header : "Conditional Logic",
  para : "To prevent unnecessary work for approvers, set logic with your approvals to ensure approvers only receive the requests that are relevant to them."
},


{
  icon : "https://www.boloforms.com/_next/static/media/pr_instaaccess.e822dad7.svg",
  header : "One-click Approvals",
  para : "Notification emails are sent to users and can be approved with a single click."
},
...

{
  ...
  para : "It is designed to be mobile-first, and seamlessly works on desktop and tablet as well."
},
{
  icon : "https://www.boloforms.com/_next/static/media/pr_processoptim.f6216ec3.svg",
  header : "Enterprise grade security",
  para : "Majority of data stored in your spreadsheet. This ensures you have the complete control of your data with end to end encryption."
},

{
  icon : "https://www.boloforms.com/_next/static/media/pr_dashboard.64597267.svg",
  header : "Custom Dashboard",
  para : "Track approvals of various forms from a single place! See the approval process for each request in real-time"
},
]
...
export const array3 = [
  ...
  {
    question : "How to calculate the number of request based on email quota?",
...
export const box3 = [
  ...
  {
    product : "Google form UI enhancer"
  },
  {
    product : "Boloforms Document Generator"
  },
  {
    product : "Timer + Proctor"
  },
  {
    product : "Google Meet Attendence Tracker"
  },
]
